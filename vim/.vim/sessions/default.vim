...
nmap <silent> cs% <Plug>(matchup-cs%)
nmap cS <Plug>CSurround
nmap cs <Plug>Csurround
nmap <silent> ds% <Plug>(matchup-ds%)
...
nnoremap <silent> <Plug>(matchup-cs%) :call matchup#surround#delimited(0, "c", 'delim_all')
nnoremap <silent> <Plug>(matchup-ds%) :call matchup#surround#delimited(0, "d", 'delim_all')
...
inoremap <buffer> <silent> <F12> =AutoPairsFastWrap()
